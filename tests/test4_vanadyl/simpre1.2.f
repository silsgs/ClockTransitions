...
c
 ...
 611    continue
  27  continue
c      write(3,*)'Eigenvectors'
c      do 243 iq=1, 26
c      write(3,900)(zz(jj,iq),jj=1,ix)
c      write(3,900)(zz(jj,2),jj=1,ix)
c      write(3,900)(zz(jj,3),jj=1,ix)
c      write(3,900)(zz(jj,4),jj=1,ix)
c      write(3,900)(zz(jj,5),jj=1,ix)
c      write(3,900)(zz(jj,6),jj=1,ix)
c      write(3,900)(zz(jj,7),jj=1,ix)
c      write(3,900)(zz(jj,8),jj=1,ix)
c      write(3,900)(zz(jj,9),jj=1,ix)
c      write(3,900)(zz(jj,10),jj=1,ix)
c      write(3,900)(zz(jj,11),jj=1,ix)
 243  continue
 900  format(400f14.10)
c
c
 203  format (/'     *** LAPACK ERROR *** '/
     & 'problems in the diagonalization process'/
